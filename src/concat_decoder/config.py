...
class CircuitConfig:
    ...
    # concat-decoder-local options. Mapped inside circuit_factory to backend-specific APIs.
...
class HybridTwoStageConfig:
    ...
    debug_dump_dir: str = "concat_decoder_outputs/hybrid_debug"
...
class DecoderConfig:
    ...
    # UnionFindDecoder (decode/decode_batch) and propagate them through concat-decoder.
    ...
    def from_dict(data: dict[str, Any]) -> "DecoderConfig":
        ...
        # Canonical names used by concat-decoder:
        # - 'uf' for union-find
        if "strategy" in raw:
        ...
        hybrid = HybridTwoStageConfig(
            ...
            debug_dump_dir=str(hybrid_raw.get("debug_dump_dir", "concat_decoder_outputs/hybrid_debug")),
...
class ThresholdExperimentConfig:
    ...
    output_dir: str = "concat_decoder_outputs/threshold"
    resume: bool = True
