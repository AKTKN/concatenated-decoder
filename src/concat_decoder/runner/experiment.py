...
from ..circuit.factory import build_circuit
...
from ..decoder._unsupported.chromobius import ChromobiusDecoder
from ..decoder._unsupported.concat_bp_lsd import ConcatBPLSDDecoder
from ..decoder._unsupported.concat_relay_bp import ConcatRelayBPDecoder
from ..decoder._unsupported.concat_belief_find import ConcatBeliefFindDecoder
from ..decoder._unsupported.concat_belief_concat_mwpm import ConcatBeliefConcatMWPMDecoder
from ..decoder._unsupported.concat_find import ConcatFindDecoder
from ..decoder.concat_bp_matching import ConcatBeliefMatchingDecoder
from ..decoder.concat_mwpm import ConcatMatchingDecoder
from ..dem.model import parse_detector_metadata, parse_stim_dem
from ..utils.stats_io import (
    write_detailed_stats_parquet, load_existing_points, merge_existing_rows,
    write_threshold_csv, write_meta
)
from ..utils.visualization import plot_thresholds
from ..utils.stats import compute_failure_stats, scale_interval
from ..utils.comparative import decode_batch_comparative, get_obs_detector_ids_by_obs_index
from ..utils.detailed_stats_writer import ShotStatsParquetWriter, make_detailed_stats_filename
from ..utils.cluster_stats_writer import ClusterStatsParquetWriter, make_cluster_stats_filename
from ..utils._debug_io import dump_stim_circuit
...
def _run_threshold_task(
    ...
    if bool(getattr(decoder_cfg, "debug_print_stage1_bp_summary", False)) and hasattr(decoder, "print_stage1_bp_summary"):
        ...
        try:
            ...
            print(f"[concat-decoder][stage1_bp_nonconvergence_summary] failed to print summary: {exc}")
...
def run_threshold_experiment(
    ...
    circuits_dir = Path("concat_decoder_circuits")
    dumped: set[str] = set()
